 ...
 */
@WebServlet(value = "/register/*", asyncSupported = true, displayName = "eVento - registration")
@VaadinServletConfiguration(productionMode = false, ui = EventoUI.class)
public class RegisterServlet extends AlgosServlet {
