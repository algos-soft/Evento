 ...
 */
public class NavigatorViewProvider extends Navigator.ClassBasedViewProvider {
     ...
     */
    public NavigatorViewProvider(String viewName, Class<? extends View> viewClass, boolean caching) {
